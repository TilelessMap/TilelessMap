...
$(THE_APP_ROOT)/handle_db.c \
$(THE_APP_ROOT)/shader_utils.c \
$(THE_APP_ROOT)/utils.c \
$(THE_APP_ROOT)/getData.c \
$(THE_APP_ROOT)/eventHandling.c \
$(THE_APP_ROOT)/twkb.c \
$(THE_APP_ROOT)/varint.c \
$(THE_APP_ROOT)/twkb_decode.c \
$(THE_APP_ROOT)/rendering.c \
$(THE_APP_ROOT)/touch.c \
$(THE_APP_ROOT)/main.c
