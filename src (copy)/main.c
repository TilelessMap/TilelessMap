...
//	oneLayer->has_text=0;
	...
	reset_shaders(vs, fs, program);
        ...
        log_this(10, "put prepared statement from sql : %s, into : %p\n",sql,oneLayer->preparedStatement );
